...
<?php
include 'db.php';
$query = "SELECT * FROM graphics_card ORDER BY ID";
...
$sql = "INSERT INTO graphics_card (ID, BRAND, NAME, PRICE, VERSION, PIC_FILE_NAME, IN_STOCK, DAY_DEAL)
VALUES ('$ID', '$BRAND', '$NAME', '$PRICE', '$VERSION', '$PIC_FILE_NAME', '$IN_STOCK', '$DAY_DEAL')";
if($conn->query($sql)){
