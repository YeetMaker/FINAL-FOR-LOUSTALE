...
if ($result = $mysqli->query($query)) {
 ...
 $TOUCH_SCREEN = filter_input(INPUT_POST, 'TOUCH_SCREEN');
 $STORAGE_IN_GIGABYTES = filter_input(INPUT_POST, 'STORAGE_IN_GIGABYTES');
...
$sql = "INSERT INTO laptops (ID, NAME, BRAND, PRICE, TOUCH_SCREEN, STORAGE_IN_GIGABYTES, RAM, PIC_FILE_NAME, IN_STOCK)
VALUES ('$ID', '$NAME', '$BRAND', '$PRICE', '$TOUCH_SCREEN', '$STORAGE_IN_GIGABYTES', '$RAM', '$PIC_FILE_NAME', '$IN_STOCK', '$DAY_DEAL')";
if($conn->query($sql)){
