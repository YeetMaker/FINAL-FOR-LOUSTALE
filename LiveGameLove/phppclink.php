...
if ($result = $mysqli->query($query)) {
 ...
 $GRAPHICS_CARD = filter_input(INPUT_POST, 'GRAPHICS_CARD');
...
$sql = "INSERT INTO pc (ID, NAME, BRAND, PRICE, GRAPHICS_CARD, STORAGE_IN_GIGABYTES, RAM, PIC_FILE_NAME, IN_STOCK)
VALUES ('$ID', '$NAME', '$BRAND', '$PRICE', '$GRAPHICS_CARD', '$STORAGE_IN_GIGABYTES', '$RAM', '$PIC_FILE_NAME', '$IN_STOCK', '$DAY_DEAL')";
if($conn->query($sql)){
