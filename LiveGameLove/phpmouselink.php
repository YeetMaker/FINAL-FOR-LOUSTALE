...
<?php
include 'db.php';
$query = "SELECT * FROM gamingmouse ORDER BY ID";
if ($result = $mysqli->query($query)) {
 ...
 $MAX_DPI = filter_input(INPUT_POST, 'MAX_DPI');
 $BUTTONS = filter_input(INPUT_POST, 'BUTTONS');
...
$sql = "INSERT INTO gamingmouse (ID, NAME, BRAND, PRICE, WIRELESS, MAX_DPI, BUTTONS, COLOR, PIC_FILE_NAME, IN_STOCK)
VALUES ('$ID', '$NAME', '$BRAND', '$PRICE', '$WIRELESS', '$MAX_DPI', '$BUTTONS', '$COLOR', '$PIC_FILE_NAME', '$IN_STOCK', '$DAY_DEAL')";
if($conn->query($sql)){
